...
public class CallerJSON_MiMovistarPagoRecibo {

    private static final String EXCEL_WEB = "excel/MiMovistar_PagoRecibo.xlsx";
    ...
    private static String blockIP(String ip) throws IOException {
        ...
        HttpPost post = new HttpPost("https://api.us-east.apiconnect.ibmcloud.com/telefonica-del-peru-development/topen/webviews/v1/users/me/phone-numbers/920957951/webviews/account_bill_payment");
